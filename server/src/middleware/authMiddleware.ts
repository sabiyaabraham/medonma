...
import { protectUser as protectUser_, protectAdmin as protectAdmin_ } from "../services/authService";
...
// @ts-ignore
export const protectUser = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
